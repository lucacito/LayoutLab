...
4. **Carry over global styles last.** Note your Divi global colors and font choices, then set the equivalent values in Elementor's Site Settings once the structural rebuild is done, the same "presets last" order recommended for [importing any layout](/guides/how-to-import-a-divi-5-layout), just running in reverse.
