...
describe('/plugins/beaver-builder-to-divi-5', () => {
  it('sells Pro at $25/yr and links the free plugin on wordpress.org', () => {
    render(<BeaverPage />);
    ...
    expect(free[0]!.getAttribute('href')).toBe('https://wordpress.org/plugins/jhmg-converter-for-beaver-builder-to-divi/');
